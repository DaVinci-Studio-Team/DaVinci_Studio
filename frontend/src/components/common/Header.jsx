        ...
        <div className='mb-4 text-center lg:mb-16'>
            <div className="inline-block mb-6 group">
                <div className="relative flex items-center justify-center w-24 h-24">
                    <div className="absolute inset-0 transition rounded-full opacity-50 blur-2xl bg-gradient-to-r from-purple-800 via-blue-700 to-pink-700 group-hover:opacity-80"></div>
